...
export const toolsConfig: ToolsConfig = [
	...
	{
		toolName: 'Серверная разработка на NodeJS',
		description: [
				'Писал сервера для своих проектов. Затем пошёл на обучающий курс где использовал Express, затем Nest. Базу данных строил на MongoDB, Postgres. Писал чистые запросы и через Mongoose и TypeORM. Научился отправлять письма и сохранять файлы в облаке. Познакомился с микросервисами.',
			],
	},
	{
		toolName: 'Тесты',
