...
export const toolsConfig: ToolsConfig = [
	...
	},
	{
		toolName: 'Docker',
		description: [
			'Запускаю проекты в контейнерах. Пишу Dockerfile и docker-compose.yml. Знаю как собрать для разработки и для публикации.',
		],
	},
	{
		toolName: 'Доставка кода',
		description: [
			'Ansible для установки программ. Jenkins для автоматического разворачивания приложения после коммита в мастер. Развернул собственный домашний сервер.',
		],
	},
	{
		toolName: 'Прочее',
		description: [
			...
			'Есть опыт просмотра кода новых членов команды с советами как писать лаконичнее и проще.',
		],
	},
]
